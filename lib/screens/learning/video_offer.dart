...
class VideoOffer extends StatelessWidget {
  final String price;
  final bool? isPaid;
  final String id;
  const VideoOffer(
      {super.key, required this.price, this.isPaid, required this.id});
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: SizedBox(
                                ...
                                child: Text(
                                  'Unlock many benefits that can be obtained in the video learning',
                                  maxLines: 3,
                            ...
                            Container(
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  // Get.rootDelegate.toNamed(routeLearnVideo,
