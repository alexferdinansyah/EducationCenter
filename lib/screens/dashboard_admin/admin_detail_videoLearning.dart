...
class AdminDetailVideolearning extends StatefulWidget {
  const AdminDetailVideolearning({super.key});

  @override
  State<AdminDetailVideolearning> createState() =>
      _AdminDetailVideolearningState();
}

class _AdminDetailVideolearningState extends State<AdminDetailVideolearning> {
  String id = '';
  String imageUrl = '';
  bool showSave = true;
  ...
  Future<void> deleteExistingPhoto() async {
    if (imageUrl != '') {
      try {
        ...
        String fileName =
            fileUrl!.replaceFirst("thumbnail_videoLearning%2F", "");
            ...
            children: [
                              ...
                              builder: (context, sizingInformation) {
                                if (sizingInformation.deviceScreenType ==
                                  ...
                                  return _defaultHeader(width,
                                      videoImage: videoLearning.image,
                                    ...
                                    SizedBox(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Expanded(
                                            child: TextFormField(
                                              initialValue: videoLearning.price,
                                              style: GoogleFonts.mulish(
                                                  color: CusColors.title,
                                                  fontSize:
                                                      getValueForScreenType<
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    if (videoLearning.isDraft != false)
                      SizedBox(
                        height: getValueForScreenType<double>(
                          context: context,
                          mobile: 26,
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          if (_formKey.currentState!.validate()) {
                            ...
                            if (videoLearning.isDraft!) {
                              await firestore.updatelearningVideoDataEachField(
                                  videoLearningId: id,
                                  fieldName: 'is_draft',
                                  data: false);
                            }
                        ...
                        child: Text(
                          videoLearning.isDraft! ? 'Publish' : 'Save',
                          style: GoogleFonts.poppins(
                            fontSize: getValueForScreenType<double>(
                              context: context,
                              mobile: width * .018,
            ...
            child: image != null
                ...
                : videoImage != ''
                    ? GestureDetector(
                        ...
                        child: ClipRRect(
                            borderRadius: BorderRadius.circular(20),
                            child: Image.network(videoImage!, width: width / 2.7)),
                      )
                    : GestureDetector(
                        onTap: selectImageFromGallery,
                        child: Container(
                    ...
                    children: [
                      videoImage != ''
                          ? ClipRRect(
                              borderRadius: BorderRadius.circular(20),
                              child:
                                  Image.network(videoImage!, width: double.infinity),
                            )
                          : Container(
                              width: width / 2.7,
                              height: 200,
