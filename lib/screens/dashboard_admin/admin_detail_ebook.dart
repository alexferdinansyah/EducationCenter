...
class _AdminDetailEbookState extends State<AdminDetailEbook> {
  String id='';
  String imageUrl='';
  bool showSave=true;
  ...
  Future<void> deleteExistingPhoto() async {
    if (imageUrl != '') {
      try {
        ...
        String fileName = fileUrl!.replaceFirst("thumbnail_ebook%2F", "");
            ...
            child: image != null
                ...
                : EbookImage != ''
                    ? GestureDetector(
                        ...
                        child: ClipRRect(
                            borderRadius: BorderRadius.circular(20),
                            child: Image.network(EbookImage!, width: width / 2.7)),
                      )
                    : GestureDetector(
                        onTap: selectImageFromGallery,
                        child: Container(
                    ...
                    children: [
                      EbookImage != ''
                          ? ClipRRect(
                              borderRadius: BorderRadius.circular(20),
                              child:
                                  Image.network(EbookImage!, width: double.infinity),
                            )
                          : Container(
                              width: width / 2.7,
                              height: 200,
