...
class ListWebinars extends StatelessWidget {
  final ListWebinar listWebinar;
  final int index;
  const ListWebinars(
      {super.key, required this.listWebinar, required this.index});
            ...
            decoration: listWebinar.image != ''
                ? BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: NetworkImage(listWebinar.image!),
...
class AdminWebinars extends StatelessWidget {
  final Webinar webinar;
  final String id;
  final bool isAdmin;
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Text(
                            isAdmin ? 'Edit webinar' : 'Learn webinar',
                            style: GoogleFonts.mulish(
